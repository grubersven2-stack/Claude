...
if mod(step, 200) == 0
    ...
    [evapRate_physics, Q_evap_actual] = calculatePhaseChangePhysics(state, params, Q_input_total);
    ...
    Q_input_net = Q_evap_actual - Q_losses;

    % Calculate actual efficiency for tracking/plotting
    current_energy_factor = Q_evap_actual / max(Q_input_total, 1);
...
function [dmEvap_dt, Q_latent_evap] = calculatePhaseChangePhysics(state, params, Q_available)
